...
In the past, I've spent many hours preparing each performance review. Back then, I formatted them as letters. Lots of paragraphs and not many bullet points. This process required a significant effort from me, so it didn't scale. But also, that format wasn't that helpful for direct reports.
