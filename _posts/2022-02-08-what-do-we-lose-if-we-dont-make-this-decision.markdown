...
**“What do we lose if we don’t make this decision?”** is a powerful question for a decision that feels scary. It enables to lay out the opportunities and expected results. It also reminds us that most decisions are reversible. And it can uncover reasons that made the discussion feel stuck.
