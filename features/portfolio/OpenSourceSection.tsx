...
export default function OpenSourceSection() {
  return (
    <>
      <SecondarySectionHeader>{"Open Source Contributions"}</SecondarySectionHeader>
      ...
      <UnorderedList spacing={1} fontSize="md">
        <ListItem>
          <Link isExternal href={"https://github.com/Couchers-org/couchers/pull/2843"}>
            Couchers-org/couchers: Reimplement dashboard with new design
          </Link>
        </ListItem>
        <ListItem>
          <Link isExternal href={"https://github.com/Couchers-org/couchers/pull/2918"}>
            Couchers-org/couchers: Implement hero section in dashboard with search
          </Link>
        </ListItem>
        <ListItem>
          <Link isExternal href={"https://github.com/tadashi-yama1012/next-rss/issues/5"}>
        ...
        <ListItem>
          ...
          {" or the "}
          <Link isExternal href={"https://github.com/guillermodlpa/deportravel-rip-page"}>
        ...
        <ListItem>
          ...
          {", "}
          <Link isExternal href={"https://github.com/mapbox/mapbox-gl-vintage-style/pull/3"}>
            this one in a Mapbox preset
          </Link>
          {", "}
          <Link isExternal href={"https://github.com/coston/react-obfuscate/issues/302"}>
            this one in coston/react-obfuscate
          </Link>
          {" and "}
          <Link isExternal href={"https://github.com/uploadcare/uploadcare-widget/issues/925"}>
